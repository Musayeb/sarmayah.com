...
branding:false,
  ...
  ed.on('keyup', function (e) { 
      ...
      if (resultArray.length>50) {
          $('#character_count16').css("color", "#e83b3b");
          $('#investment_manage').attr('disabled',true);

    
        }else{
          $('#character_count17').css("color","#272526");
          $('#investment_manage').attr('disabled',false);
        }
     }                     
...
branding:false,
        ...
        setup: function (ed) {
  ed.on('keyup', function (e) { 
       var body = tinymce.get("mymce18").getBody();
       var content = tinymce.trim(body.innerText);
       var resultArray = [];
      var str =content.replace(/[\t\n\r\.\?\!]/gm,' ');
      var wordArray = str.split(" ");
      for (var i = 0; i < wordArray.length; i++) {
        ...
        if (resultArray.length<200||resultArray.length>400) {
          $('#character_count18').css("color", "#e83b3b");
          $('#expansion_plan').attr('disabled',true);

    
        }else{
          $('#character_count18').css("color","#272526");
          $('#expansion_plan').attr('disabled',false);
        }
     }                     
      document.querySelector("#character_count18").innerHTML =resultArray.length+' WORDS';
  });

},
});
tinymce.init({
  selector: 'textarea#mymce19',
          plugins: [
            "advlist autolink link  lists  paste"],
             oninit : "setPlainText",
              verify_html :false,
...
branding:false,
        ...
        setup: function (ed) {
  ed.on('keyup', function (e) { 
       var body = tinymce.get("mymce19").getBody();
       var content = tinymce.trim(body.innerText);
       var resultArray = [];
      var str =content.replace(/[\t\n\r\.\?\!]/gm,' ');
      var wordArray = str.split(" ");
      ...
      if (resultArray.length<200||resultArray.length>400) {
          $('#character_count19').css("color", "#e83b3b");
          $('#expansion_summary').attr('disabled',true);

    
        }else{
          $('#character_count19').css("color","#272526");
          $('#expansion_summary').attr('disabled',false);
        }
     }                     
      document.querySelector("#character_count19").innerHTML =resultArray.length+' WORDS';
  });

},
});
tinymce.init({
  selector: 'textarea#mymce20',
         plugins: [
            "advlist autolink link  lists  paste"],
             oninit : "setPlainText",
              verify_html :false,
...
branding:false,
        ...
        setup: function (ed) {
  ed.on('keyup', function (e) { 
       var body = tinymce.get("mymce20").getBody();
       var content = tinymce.trim(body.innerText);
       var resultArray = [];
      var str =content.replace(/[\t\n\r\.\?\!]/gm,' ');
      var wordArray = str.split(" ");
      for (var i = 0; i < wordArray.length; i++) {
        ...
        if (resultArray.length<200||resultArray.length>400) {
          $('#character_count20').css("color", "#e83b3b");
          $('#target_market').attr('disabled',true);

    
        }else{
          $('#character_count20').css("color","#272526");
          $('#target_market').attr('disabled',false);
        }
     }                     
      document.querySelector("#character_count20").innerHTML =resultArray.length+' WORDS';
  });

},
});
tinymce.init({
  selector: 'textarea#mymce21',
          plugins: [
            "advlist autolink link  lists  paste"],
             oninit : "setPlainText",
              verify_html :false,
...
branding:false,
        ...
        setup: function (ed) {
  ed.on('keyup', function (e) { 
       var body = tinymce.get("mymce21").getBody();
       var content = tinymce.trim(body.innerText);
       var resultArray = [];
      var str =content.replace(/[\t\n\r\.\?\!]/gm,' ');
      var wordArray = str.split(" ");
      ...
      if (resultArray.length<200||resultArray.length>400) {
          $('#character_count21').css("color", "#e83b3b");
          $('#market_study').attr('disabled',true);

    
        }else{
          $('#character_count21').css("color","#272526");
          $('#market_study').attr('disabled',false);
        }
     }                     
      document.querySelector("#character_count21").innerHTML =resultArray.length+' WORDS';
  });

},
});
tinymce.init({
  selector: 'textarea#mymce22',
...
branding:false,
        ...
        setup: function (ed) {
  ed.on('keyup', function (e) { 
       var body = tinymce.get("mymce22").getBody();
       var content = tinymce.trim(body.innerText);
       var resultArray = [];
      var str =content.replace(/[\t\n\r\.\?\!]/gm,' ');
      var wordArray = str.split(" ");
      ...
      if (resultArray.length<200||resultArray.length>400) {
          $('#character_count22').css("color", "#e83b3b");
          $('#product_upgrade').attr('disabled',true);

    
        }else{
          $('#character_count22').css("color","#272526");
          $('#product_upgrade').attr('disabled',false);
        }
     }                     
      document.querySelector("#character_count22").innerHTML =resultArray.length+' WORDS';
  });
...
branding:false,
        ...
        setup: function (ed) {
  ed.on('keyup', function (e) { 
       var body = tinymce.get("mymce23").getBody();
       var content = tinymce.trim(body.innerText);
       var resultArray = [];
      var str =content.replace(/[\t\n\r\.\?\!]/gm,' ');
      var wordArray = str.split(" ");
      ...
      if (resultArray.length<200||resultArray.length>400) {
          $('#character_count23').css("color", "#e83b3b");
          $('#required_tech').attr('disabled',true);

    
        }else{
          $('#character_count23').css("color","#272526");
          $('#required_tech').attr('disabled',false);
        }
        
     }                     
      document.querySelector("#character_count23").innerHTML =resultArray.length+' WORDS';
  });
