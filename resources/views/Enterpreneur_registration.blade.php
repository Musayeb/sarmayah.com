@extends('master')
 @section('title')
 Business Registration - Sarmayah.com
 @endsection
...
<div class="card" style="padding:3em">
  ...
  @endif
 <h5 class="font-weight-bold text-center" style="margin-bottom:20px;">Entreprenuer Registration</h5>      

 <form method="post" action="{{url('entrepreneur_Reg')}}">
    @csrf
   <div class="col-lg-12">
              ...
              <div class="form-group">
               ...
               <select name="catagory">
                  <option value="" selected disabled>----Select category----</option> 
                     <option value="IDEA" @if(old("catagory")=='IDEA') selected @endif>Idea Phase</option> 
                    <option value="STARTUP"  @if(old("catagory")=='STARTUP') selected @endif>Startup Phase</option>
                     <option value="SME"  @if(old("catagory")=='SME') selected @endif>Growth Phase</option> 
               </select>
               {!!$errors->first('catagory', '<small style="color:red;margin-left:10px">:message</small>')!!}
            </div>
         </div>
            <div class="col">
               <div class="form-group">
     ...
     {!!$errors->first('password', '<small style="color:red;margin-left:10px">:message</small>')!!}
      ...
      <div class="form-group pl-3 pr-3">
         <label class="mb-1">You agree to Sarmayah's <a href="{{url('terms-of-use')}}">User Agreement & Privacy Policy</a></label>
