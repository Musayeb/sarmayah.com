       ...
       <div class="container">
          <div class="row">
                   ...
                   <div class="col-md-12 col-lg-4 mb-1  right order-lg-4 mt-4">
                         <a href="{{url('ad/business_profile')}}/{{$ent_id}}">
                         <button class="btn btn-info w-100">Edit Business Application &nbsp;<i class="mdi mdi-lead-pencil"></i></button>
                       </a>
                   ...
                   <article class="sticky">
                      <div class="sticky" style="position:sticky;">
                        ...
                        class="img-fluid" style="height:160px;width:100%;margin-top:15px;object-fit:contain;border-radius:4px; border-bottom-left-radius:0;border-bottom-right-radius:0;" alt="Business logo">
                           @else
                           <img src="{{url('storage/app')}}/{{($ent->logo)}}" style="margin-top:10px;height:160px;width:100%;object-fit: contain;border-radius:4px;flex-shrink: 0;" >
                          @endif
                                 ...
                                 <div class="d-flex align-items-top mb-2">
                                        ...
                                        <div  style="border-top:none;margin-left:70px ">
                                          <ul class="social" style="list-style:none;display:flex;">
                                            ...
                                            <li>
                                              <a href="{{$ent->website_url}}" target="_blank" class="socails"><i class="mdi mdi-earth " aria-hidden="true"></i></a>
                                           </li> 
                                            @endif
                                            @if(!empty($ent->facebook_url))
                                            <li>
                                                <a href="{{$ent->facebook_url}}" target="_blank" class="socails"><i class="fab fa-facebook-f" aria-hidden="true"></i></a>
                                             </li>
                                            @endif
                                            @if(!empty($ent->linkedin_url))
                                             <li>
                                                <a href="{{$ent->linkedin_url}}" target="_blank" class="socails"><i class="fab fa-linkedin-in " aria-hidden="true"></i></a>
                                             </li>
                                             @endif
                                             @if(!empty($ent->instagram_url))
                                           
                                             <li>
                                                <a href="{{$ent->instagram_url}}" target="_blank" class="socails"><i class="fab fa-instagram " aria-hidden="true" ></i></a>
                                             </li>
                                          @endif
                                            </ul>
                                       </div>
               ...
               <div class="col-lg-8">
                  ...
                  <div id="description" class="description card p-4 mt-2">
                  ...
                  <div class="card div_market_position mt-3 p-3">
                    <h6   class=" div_market_position p-2" style="background: linear-gradient(to right, #2cdd9b 0%, #1dc8cc 100%);color:#ffffff;">Market Positioning Chart</h6>
                  <iframe src="{{url('storage/app')}}/{{$ent->market_positon_file}}" style="scrollbar-width:thin;" width="100%" height="500"></iframe>
                  </div>
                    @endif
                    <section class="mt-1 card p-4">
                  ...
                  <div class="card p-2" ><h6 class=" p-2" style="background: linear-gradient(to right, #2cdd9b 0%, #1dc8cc 100%);color:#ffffff;">Financial</h6></div>
          ...
          <h6 class="p-2 pb-0" >Business Model Canvas </h6>
               ...
               <div class="d-flex mt-1 ">
                 <div class="col-md-2 pr-1 p-0">
                   <div class="btn btn-success w-100 pt-2 pb-2 mb-1 text-center model-text">1.Key Partners</div>
                 ...
                 <div class="col-md-3 pr-1 p-0 ">
                   <div class="btn btn-success w-100 pt-2 pb-2 mb-1 text-center model-text">2.Key Activities</div>
                   <div class="bg-white p-4" style="height:12em;overflow-y:scroll;">@php echo html_entity_decode($ent->Key_Activities)@endphp</div>
                   <!--  -->
                  <div class="btn btn-success w-100  pt-2 pb-2 mb-1 text-center model-text">6.Key Resources</div>
                 ...
                 <div class="col-md-2 p-0 pr-1">
                   <div class="btn btn-success w-100 pt-2 pb-2 mb-1 text-center model-text" >3.Value Propositions</div>
                  <div class="bg-white p-4" style="height:27em;overflow-y:scroll;">@php echo html_entity_decode($ent->Value_Propositions)@endphp</div> 
                   <!--  -->
                  
                 </div>
                 <div class="col-md-3  pr-1 p-0">
                   <div class="btn btn-success w-100 pt-2 pb-2 mb-1 text-center model-text" >4.Customer Relationships</div>
                    ...
                    <!--  -->
                     <div class="btn btn-success w-100 pl-1 pt-2 pb-2 mb-1 text-center model-text">7.Channels</div>
                     <div class="bg-white p-4" style="height:12em;overflow-y:scroll;">@php echo html_entity_decode($ent->Channels)@endphp</div> 


                 </div>
                   <div class="col-md-2  pr-1 p-0">
                   <div class="btn btn-success w-100 pt-2 pb-2 mb-1 text-center model-text">5.Customer Segments</div>
               ...
               <div class="d-flex">
                 <div class="col-md-6 " style="padding:0px 0px">
                    <div class="btn btn-success w-100 pt-2 pb-2 mb-1 text-center model-text">8.Cost Structure</div>
                 ...
                 <div class="col-md-6 " style="padding:0px 5px">
                     <div class="btn btn-success w-100 pt-2 pb-2 mb-1 text-center model-text">9.Revenue Streams</div>
           ...
           <h5>Investment Management</h5>
            <div class="d-flex">
              <div class="col-lg-6 border-right" style="padding:0px 0px">
                <div class="bg-white  p-4 mt-2"  style="text-align: justify;text-justify: inter-word">
