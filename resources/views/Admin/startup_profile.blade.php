      ...
      <div>
        ...
        <div class="card-body" style="padding-top:0px" >
            ...
            <div class="sticky-center">
              <h4 class="card-title">Startup Information
             &nbsp;<small>
                 @if($ent->admin_status=="Draft")<span class="badge badge-warning" data-toggle="tooltip"title="Complete your profile to be approved by admin">{{$ent->admin_status}}</span>@endif
                  ...
                  @if($ent->admin_status=="Rejected")<span class="badge badge-danger">{{$ent->admin_status}}</span>@endif</small>
                    @if($ent->admin_status=="Submitted")<span class="badge badge-info">{{$ent->admin_status}}</span>@endif</small>
              ...
              <div class="tabs sticky">
                ...
                <div class="tab-pane active" id="home1" role="tabpanel" style="padding:40px">
                    <a href="{{url('ad/startup/add/team/member')}}/{{$id1}}"><button class="btn btn-success float-right mb-2">Add Team Member <i class="mdi mdi-plus"></i></button></a>
                    @php $number=1;@endphp
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        <tr id="row{{$id}}">
                         ...
                         <td>
                            <a href="{{url('ad/startup/edit/team/member')}}/member={{$id}}"><i class="mdi mdi-pencil text-info mdi-lg" style="font-size:20px"></i></a>
    ...
    <div class="tab-pane p-20" id="messages12" role="tabpanel" style="padding:40px">
       <div class="row">
           <div class="col-md-2"></div>
               <div class="col-md-7"> 
                <label data-toggle="tooltip" title="Define your marketing strategy">Calculate the cost of customer Acquisition (Maximum Words 300)<label class="text-danger h5">*</label></label>
...
<button class="btn btn-success float-right mt-5" id="life_cycle_btn_next">Next</button>
  ...
  <div class="tab-pane justify-content-center p-20" id="profile3" role="tabpanel" style="padding:40px">
          ...
          <div class="col-md-7">
            ...
            <label> High-level Product Specifications (Maximum 300 Word) <label class="text-danger h5">*</label></label>
            ...
            <label> Why the customers need your product/service and why they have to pay for it? (Maximum 300 Word) <label class="text-danger h5 mt-2">*</label></label>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <label >Elevator Pitch (Maximum Words 100-300) *</label>
...
<div class="tab-pane p-5" id="messages9" role="tabpanel" style="padding:40px">
               ...
               <div class="row mb-5">
                      ...
                      <div class="col-md-7">
                        ...
                        <div class="form-group">
                          <label class="mb-4">Define your investment terms <small>(Maximum words 100-300)</small><label class="text-danger h5">*</label></label>
                        ...
                        <div class="form-group mt-4">
                          <label class="mb-4">Define your plan for management of the received investment amount  <small>(Maximum words 100-300)</small><label class="text-danger h5">*</label></label>
                        ...
                        <div class="form-group">
                          <label class="mb-4">Breakdown the costs you will use the investment amount for? <small>(Maximum words 100-300)</small><label class="text-danger h5">*</label></label>
                  ...
                  <div class="col-md-2"></div>
                     <div class="col-md-7" > 
                      <div class="form-group mb-5">
                        ...
                        <label class="mb-4">The Market <small>(Maximum words 300-400)</small><label class="text-danger h5">*</label></label>
                      ...
                      <div>
                        ...
                        <div class="mt-5">
                        <form action="{{url('ad/startup/store_market_position')}}" method="post" enctype="multipart/form-data">
                            @csrf
                                <div class="form-group">
                                    <label class="card-title">Select Market Positioning <small>(pdf 2MB)</small></label>
...
{{--  end of market positioning  --}}
        ...
        <div class="tab-pane p-20" id="messages4" role="tabpanel" style="padding:40px">
           <div class="row">
             ...
             <div class="col-md-6" >
                <div class="form-group">
                    <form action="{{url('ad/startup/busniess_logo/update')}}" method="post" enctype="multipart/form-data">
                        @csrf
         ...
         <div class="col-md-6">
            <div class="form-group">
                <form action="{{url('ad/startup/Business_profile/update')}}" method="post" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="row">
        <div class="col-md-6">
              <form action="{{url('ad/startup/busniess_plan/update')}}" method="post" enctype="multipart/form-data">
                  @csrf  
                    <div class="form-group">
        ...
        <div class="col-md-6">
            <form action="{{url('ad/startup/pitch_deck/update')}}" method="post" enctype="multipart/form-data">
                @csrf  
                  <div class="form-group">                     
          ...
          <div class="row">
                ...
                <div class="col-md-6">
                    <form action="{{url('ad/startup/busniess_license/update')}}" method="post" enctype="multipart/form-data">
                        @csrf  
                        <div class="form-group">
                                <label class="card-title">Business License <small>(pdf 5MB)</small></label>
                                <input type="file" id="input-file-now4" name="busniess_license" class="dropify" data-allowed-file-extensions="pdf" data-max-file-size-preview="5M" />
                                <button data-toggle="tooltip" data-placement="top" data-original-title="upload" type="submit" class="btn btn-success mt-1 float-right" ><i class="mdi mdi-upload"></i> Upload</button>
...
jQuery("#first").submit(function(e){
 $('#sub12').html('<i class="fa fa-spinner fa-spin"></i>&nbsp;Saving....').attr('disabled',true);  
    ...
    var url ="{{url('ad/startup/profile/update')}}";
    $.ajax({
    type:'POST',
     url:url,
     data: {hide_input:hide_input,startup_name:startup_name,
...
$(document).ready(function () {
 $('#submit_define').click(function(){
  ...
  var hide_input=$('#hide_input').val();
  var url="{{url('ad/startup/business_minimum_viable_product')}}";
    $.ajaxSetup({
        headers: {
            'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
        }
...
$('#product_specifications').click(function(){
 ...
 var body = tinymce.get("mymce14").getContent();
  ...
  var url="{{url('ad/startup/high_level_product')}}";
  $.ajaxSetup({
        headers: {
            'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
        }
...
$('#product_need').click(function(){
 ...
 var body = tinymce.get("mymce15").getContent();
  var hide_input=$('#hide_input').val();
 var inputdata = JSON.stringify({'inputdata':body});
 var url="{{url('ad/startup/product_need/')}}";
  $.ajaxSetup({
        headers: {
            'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
        }
...
$('#product_plan_btn').click(function(){
 ...
 var url="{{url('ad/startup/product_plan/')}}";
  $.ajaxSetup({
        headers: {
            'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
        }
...
$('#busniess_submit').click(function(){
 $(this).html('<i class="fa fa-spinner fa-spin"></i>&nbsp;Saving....').attr('disabled',true);  
  ...
  var url="{{url('ad/startup/store_busniess_model')}}";
  $.ajaxSetup({
        headers: {
            'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
        }
  ...
  $.ajax({
    type:'POST',
     url:url,
     data: {inputdata:inputdata,hidden:input,hide_input:hide_input},
     success:function(data){ 
        $.toast({
           heading: '<small>{{"Information updated successfully!"}}</small>',
           position: 'top-right',
    ...
    //     $("#messages10").reload(location.href+" #messages10>*","");
    //     }, 10);
    },
    error:function(){
...
$('#elavtor_submit').click(function(){
 $(this).html('<i class="fa fa-spinner fa-spin"></i>&nbsp;Saving....').attr('disabled',true);  
  ...
  var inputdata = JSON.stringify({'inputdata':body});
  var hide_input=$('#hide_input').val();
  var url="{{url('ad/startup/profile/update1')}}";
  $.ajaxSetup({
        headers: {
            'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
        }
...
$("#bsniess__trends_submit").click(function(e){
 $('#bsniess__trends_submit').html('<i class="fa fa-spinner fa-spin"></i>&nbsp;Saving....').attr('disabled',true);  
    ...
    var inputdata = JSON.stringify({'inputdata':body});
    var hide_input=$('#hide_input').val();
    var url ="{{url('ad/startup/busness_trends_add')}}";
    $.ajax({
    type:'POST',
     url:url,
     data: {hide_input:hide_input,inputdata:inputdata},
...
$('#risk_button').click(function(){
    ...
    var inputdata = JSON.stringify({'inputdata':body});
    var url="{{url('ad/startup/risk_a_add')}}";
     $.ajaxSetup({
           headers: {
               'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
           }
...
$('#the_market_btn').click(function(){
    ...
    var inputdata = JSON.stringify({'inputdata':body});
    var url="{{url('ad/startup/store_the_market')}}";
    var hide_input=$('#hide_input').val();
...
$('#def_investment_btn').click(function(){
    ...
    var inputdata = JSON.stringify({'inputdata':body});
    var hide_input=$('#hide_input').val();
    var url="{{url('ad/startup/store_define_invest')}}";
    $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
            }
...
$('#define_your_plan').click(function(){
    ...
    var inputdata = JSON.stringify({'inputdata':body});
    var hide_input=$('#hide_input').val();
    var url="{{url('ad/startup/store_define_invest_plan')}}";
    $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
            }
...
$('#breakdown_btn').click(function(){
    ...
    var inputdata = JSON.stringify({'inputdata':body});
    var hide_input=$('#hide_input').val();
    var url="{{url('ad/startup/store_define_invest_breakdown')}}";
    $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
            }
...
$('#calculate_btn').click(function(){
    ...
    var inputdata = JSON.stringify({'inputdata':body});
    var hide_input=$('#hide_input').val();
    var url="{{url('ad/startup/calculate_cost')}}";
    $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
            }
...
$('#segment_market_btn').click(function(){
    ...
    var url="{{url('ad/startup/store_market_segment')}}";
    $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
            }
...
jQuery("#question_form").submit(function(e){
  ...
  $('#question_btn').html('<i class="fa fa-spinner fa-spin"></i>&nbsp;Saving....').attr('disabled',true);  
    ...
    $.ajax({
    type:'POST',
    url:"{{ url('ad/startup/b_head_question') }}",
...
$('#beachhead_summary_btn').click(function(){
 $(this).html('<i class="fa fa-spinner fa-spin"></i>&nbsp;Saving....').attr('disabled',true);  
  ...
  var url="{{url('ad/startup/b_head_summary')}}";
  $.ajaxSetup({
        headers: {
            'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
        }
...
$('#total_market_size').click(function(){
  ...
  var inputdata = JSON.stringify({'inputdata':body});
  var url="{{url('ad/startup/b_head_total_market_size')}}";
  $.ajaxSetup({
        headers: {
            'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
        }
...
$('#life_cycle_btn').click(function(){
 ...
 var hide_input=$('#hide_input').val(); 
 var inputdata = JSON.stringify({'inputdata':body});
 var url="{{url('ad/startup/b_head_market_life_cycle')}}";
  $.ajaxSetup({
        headers: {
            'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
        }
 ...
 jQuery("#intial_invest_form").submit(function(e){
  ...
  $('#intial_invest').html('<i class="fa fa-spinner fa-spin"></i>&nbsp;Saving....').attr('disabled',true);  
    ...
    var url ="{{url('ad/startup/financial/first')}}";
    $.ajax({
    type:'POST',
     url:url,
...
jQuery("#operation_cost_form").submit(function(e){
 ...
 $('#operation_cost_btn').html('<i class="fa fa-spinner fa-spin"></i>&nbsp;Saving....').attr('disabled',true);  
   ...
   var url ="{{url('ad/startup/financial/second')}}";
   $.ajax({
   type:'POST',
    url:url,
...
jQuery("#revenue_form").submit(function(e){
 ...
 $('#revenue_btn').html('<i class="fa fa-spinner fa-spin"></i>&nbsp;Saving....').attr('disabled',true);  
   ...
   var url ="{{url('ad/startup/financial/forth')}}";
   $.ajax({
   type:'POST',
    url:url,
...
jQuery("#profit_form").submit(function(e){
 ...
 $('#profit_btn').html('<i class="fa fa-spinner fa-spin"></i>&nbsp;Saving....').attr('disabled',true);  
   ...
   var url ="{{url('ad/startup/financial/third')}}";
   $.ajax({
   type:'POST',
    url:url,
...
$('body').on( "click",'.data', function() {
    ...
    url ='{{url("ad/startup/busniess_modal_content")}}/'+data2+'/'+hide_input;
  ...
  $(".delete").click(function () {
          ...
          url = '{{url("ad/startup/add/team/member/delete")}}/'+id;
          Swal.fire({
              title: 'Are you sure?',
