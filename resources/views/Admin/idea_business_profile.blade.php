                        ...
                        <div class="card-container pr-3 pl-3 pb-3">
                              @if(empty($ent->profile_pic))
                                <img src="{{url('public/web_assist/images/person_empty.png')}}"
                                     class="round-imgs m-t-4 "  alt="Business logo">
                                @else
                                <img src="{{url('storage/app')}}/{{($ent->profile_pic)}}"
                                     class="round-imgs m-t-4"  alt="Owner avetar">
                                @endif
        ...
        <div class="container mt-1 mb-2"> 
          ...
          <h6 class="p-2 ">Implementation Plan</h6>
            ...
            <div class="col-md-4" style="padding:0px 2px"> 
                   <div class="btn btn-success w-100 pt-2 pb-2 mb-1 text-center model-text phase">phase three</div>
                ...
                <div class="col-md-4"style="padding: 0px 2px" >
                   <div class="btn btn-success w-100 pt-2 pb-2 mb-1 text-center model-text">Phase tow</div>
                   <div class="bg-white p-4" >
               ...
               <div class="col-md-4 " style="padding: 0px 2px">
                   <div class="btn btn-success w-100 pt-2 pb-2 mb-1 text-center model-text phase">phase three 
                   </div>
                   <div class="bg-white p-4" >
                ...
                <div class="bg-white p-3 mt-2 w-100"  style="text-align: justify;text-justify: inter-word">
