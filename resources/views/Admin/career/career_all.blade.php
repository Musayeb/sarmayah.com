...
@section('content')
        <div class="card">
            <div class="card-body">
                ...
                <h6 class="card-subtitle">Manage Careers</h6>
                <a href="{{url('ad/career/add')}}" class="btn btn-success float-right mb-3"><i class="mdi mdi-plus"></i> Add Career</a>
                            ...
                            <tr id="row{{$row->blog_id}}">
                                ...
                                <td>{{$row->blog_reg_date}} </td>
                                  ...
                                  <td>
                                    ...
                                    <a href="{{url('ad/career/edit')}}/{{$row->blog_id}}"><button class="btn btn-circle btn-info edit" ><i class="fas fa-pencil-alt"></i></button></a>
                                 </td>
                            </tr>
                           @endforeach
                        </tbody>
