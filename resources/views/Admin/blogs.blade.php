...
@section('content')
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Website Blogs</h4>
                <h6 class="card-subtitle">Manage Blogs</h6>
                <a href="{{url('ad/blogs/add')}}" class="btn btn-success float-right mb-3"><i class="mdi mdi-plus"></i> Add Blog</a>
                            ...
                            <tr id="row{{$row->blog_id}}">
                                ...
                                <td>{{$row->blog_reg_date}} </td>
                                  ...
                                  <td>
                                    ...
                                    <a href="{{url('edit_blog')}}/{{$row->blog_id}}"><button class="btn btn-circle btn-info edit" ><i class="fas fa-pencil-alt"></i></button></a>
                                 </td>
                            </tr>
                           @endforeach
                        </tbody>
