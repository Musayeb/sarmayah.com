@extends('master')
@section('title')
Grouth Accoount Settings - Sarmayah.com
@endsection
               ...
               <main class="col-md-8">
                  <div class="shadow-sm rounded bg-white mb-3">
                     ...
                     <div class="box-body pl-5 pr-5 pt-2">
                           <form class="js-validate" action="{{url('ent/sme/change/general')}}" method="post">
                            @csrf
                           <div class="row">
                              <!-- Input -->
                  ...
                  <div class="shadow-sm rounded bg-white mb-3">
                     ...
                     <div class="box-body pl-5 pr-5 pt-2 pb-5 pb-0">
                      <form  action="{{url('ent/sme/change/password')}}" method="post">
                      @csrf 
                        <div class="form-group">
                       ...
                       <input type="submit" name="submit" id="submits" value="Update" class="btn btn-success float-right">
                      </form>
                      </div>
                     </div>
                  </div>
