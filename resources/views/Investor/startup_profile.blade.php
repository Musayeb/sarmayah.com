...
<div class="main-page">
       <div class="container">
                   ...
                   @endif
                     ...
                     <div class="d-flex align-items-top ">
                       ...
                       <div class="d-flex align-items-top ">
                         ...
                         <div class="d-flex align-items-top ">
                           <label class="mb-0 text-muted">Startup Establishment date</label>
         ...
         <div  class="description card p-4 mt-2 shadow-lg">
               ...
               <div class="card div_market_position mt-1 p-3 shadow-lg">
...
<div class="container mt-2 " id="invest"> 
         ...
         <div id="faq" class="faq">
               ...
               <div class="card p-0 " >
                  ...
                  <div id="collapsefour" class="collapse" aria-labelledby="headingThree"
                     ...
                     <div class="card-body pl-5">
                         ...
                         @if(!empty($ent->busniess_license))  <a target="_blank" href="{{url('storage/app')}}/{{$ent->busniess_license}}"> <i class="mdi mdi-file" style="font-size:20px"></i>{{$ent->startup_name.' '. 'Business License'}}</a>
            ...
            <div id="collap7" class="collapse" aria-labelledby="headingThree"
               ...
               <div class="card-body pl-5">
                     ...
                     @if(!empty($ent->company_profile))  <a target="_blank" href="{{url('storage/app')}}/{{$ent->company_profile}}"> <i class="mdi mdi-file" style="font-size:20px"></i>{{$ent->startup_name.' '. 'Corporate Business Profile'}}</a>
         ...
         <div class="card p-0 bg-white">
            ...
            <div id="collapseseven" class="collapse" aria-labelledby="headingThree"
               ...
               <div class="card-body pl-5">
                   ...
                   @if(!empty($ent->pitch_presentation))  <a target="_blank"  href="{{url('storage/app')}}/{{$ent->busniess_plan}}"> <i class="mdi mdi-file" style="font-size:20px"></i>{{$ent->startup_name.' '. 'Business Plan'}}</a>
