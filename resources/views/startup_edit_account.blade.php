@extends('master')
@section('title')
Startup Account Settings - Sarmayah.com
@endsection
               ...
               <main class="col-md-8">
                  <div class="shadow-sm rounded bg-white mb-3">
                     ...
                     <div class="box-body pl-5 pr-5 pt-2">
                           <form class="js-validate" action="{{url('ent/startup/change/general')}}" method="post">
                            @csrf
                           <div class="row">
                              <!-- Input -->
                  ...
                  <div class="shadow-sm rounded bg-white mb-3">
                     ...
                     <div class="box-body pl-5 pr-5 pt-2 pb-5 pb-0">
                      <form  action="{{url('ent/startup/change/password')}}" method="post">
                      @csrf 
                        <div class="form-group">
                       ...
                       <input type="submit" id="submits" name="submit" value="Update" class="btn btn-success float-right">
                      </form>
                      </div>
                     </div>
                  </div>
  ...
  <script type="text/javascript">
    ...
    $("#photoform").on('submit', function(e){
        ...
        $.ajax({
            ...
            type: 'POST',
            url: '{{url("ent/startup/change/photo")}}',
