@extends('master')
@section('title')
Startup Profile Edit - Sarmayah.com
@endsection
...
@section('content')
    ...
    <div class="card" >
        <div class="card-body" >
          ...
          <h5 class="card-title text-center"> Startup Application </h5>
      ...
      <div  class="container">   
              <div class="tabs ">
                ...
                <div class="tab-pane active" id="home1" role="tabpanel" style="padding:40px">
                  <div class="container">
                    <a href="{{url('ent/startup/add/team/member')}}"><button class="btn btn-success float-right mb-2">Add Team Member <i class="mdi mdi-plus"></i></button></a>
                    @php $number=1;@endphp
                 ...
                 <div class="container">     
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label >Startup Name <label class="text-danger h5">*</label></label>
                                <input type="text" class="form-control required"  value="{{$ent->startup_name}}" 
                                id="startup_name" placeholder="Startup Name" required> 
                          {!!$errors->first('startup_name', '<small class="text-danger ml-1">:message</small>')!!}

                            </div>
                        </div>
                           <div class="col-md-6">
                            <div class="form-group">
                                <label >Startup Establishment Date <label class="text-danger h5">*</label></label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label ><abbr title="Please write your trademark name if you have registered it officially with ACBR-IP" data-toggle="tooltip"> Trademark Name</abbr> </label>
    ...
    <div class="tab-pane p-20" id="messages12" role="tabpanel" style="padding:40px">
      <div class="container">
       <div class="row justify-content-center">
               <div class="col-md-12"> 
                <label data-toggle="tooltip" title="Please mention your marketing strategies. How will you market your product/service?"> 
Calculate the cost of customer Acquisition (100-400 words)<label class="text-danger h5">*</label></label>
                ...
                <label class="mt-4" title="Please fill the third row box with the required information from  the first row" data-toggle="tooltip">Market Segmentation<label class="text-danger h5">*</label></label>
                <section>
                    <div class="container">
                    ...
                    <label class="mt-4" title=" Please select Yes or No for the following questions about the market of your product/service" data-toggle="tooltip">Beachhead Market<label class="h5 text-danger">*</label></label>
                    <table class="table">
                        <tbody >
                           <tr>
                    ...
                    <label class="mt-5" title="Considering the answer from previous question, please write a summary about your beachhead market" data-toggle="tooltip">Beachhead Market Summary (50 words)<label class="text-danger">*</label></label>
                    <div class="form-group">
        ...
        <section>
              ...
              <label >Full Life Cycle User Case <label class="text-danger h5" >*</label></label>                                                                                      
                ...
                <div class="table-responsive mb-2">
                    <table class="table table-bordered table-custom table-custom-2 life_cycle">
...
<button class="btn btn-success float-right mt-1" id="life_cycle_btn_next">Next</button>
 </div> 
  ...
  <div class="tab-pane justify-content-center p-20" id="profile3" role="tabpanel" style="padding:40px">
        ...
        <div class="container">
          <div class="row justify-content-center">
          <div class="col-md-12">
            <label class=""><abbr title="Please write down the below information for your minimum viable product.
Value: Provides consistent value to end user (Please mention consistent value your product/service will create for your customers
Pay: Prove that the economic buyer will pay something for the product placement: Please 
Feedback: Creates meaningful feedback loop with customer (end user, economic buyer and champion): Please write down how you will receive the feedback from your customers?
"> Define the business minimum viable product </abbr><label class="text-danger h5">*</label></label>
            <div class="table-responsive  mb-2">
            ...
            <label> <abbr title="Please write the specifications of your product/services that best attract your customers">High-level Product Specifications</abbr> (100-400 words) <label class="text-danger h5">*</label></label>
            ...
            <button class="btn btn-success float-right" id="product_need_btn" >Next</button>
      </div>
  </div>
...
{{-- elaveator pitch and busniess model convas --}}
      <div class="tab-pane justify-content-center p-20" id="messages10" role="tabpanel" style="padding:40px">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-md-12">
                    ...
                    <label >Elevator Pitch (Please define your business in 100-400 words) *</label>
        ...
        <div class="container mt-2 p-5 bus">
            <h6>Business Model Canvas </h6>
                 <div class="row salaam">
                   ...
                   <div class="col-md-3  pr-1 p-0">
                     ...
                     data-target="#myModal">Customer Relationships
                     <i class="mdi mdi-lead-pencil float-right"></i></div>
                 ...
                 <div class="row justify-content-center">
                     ...
                     <div class="card">
                         ...
                         <div id="collapsefour" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                             <div class="card-body">
                                 <form  method="post" id="revenue_form">
                     ...
                     <div class="card">
                         ...
                         <div id="collapsefive" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                             <div class="card-body">
                                 <form method="post" id="profit_form">
                                     @csrf
                                    <div class="row">
                                      <div class="col-md-12">
                                       <h5>First Year</h5>      
...
of the boxes, please select Yes or No based on the advantages and competitors
    ...
    b. In the vertical boxes (Please list your competitors by writing their names)">Competitive Advantages</abbr> <label class="text-danger h5">*</label></label>
                  <div  class="table-responsive " id="compat">
                              ...
                              <button type="buuton" class="btn btn-success float-right" id="compit">Save</button>

                       </div> 
                 </div>
             
             </div>
              <button type="button" class="btn btn-success float-right mt-2" id="compatitive_btn" >Next</button>
            </div>
         </div>
               ...
               <div class="row mb-2 justify-content-center">
                      <div class="col-md-12">                        
                        <div class="form-group">
                          ...
                          <button type="button" class="btn btn-success float-right" id="def_investment_btn" >Save</button> 
                        </div><br>

                        <div class="form-group mt-4">
                          <label class="mb-4">Define your plan for management of the received investment amount <label class="text-danger h5">*</label></label>
                          <textarea id="mymce12" name="plan_for_management_of__investment">  {{$invest_management[0]->plan_for_management_of__investment}}</textarea>
                           ...
                           <button type="button" class="btn btn-success float-right" id="define_your_plan" >Save</button> 
                        </div><br>

                        <div class="form-group">
                          <label class="mb-4">Breakdown the costs you will use the investment amount for? <label class="text-danger h5">*</label></label>
                        ...
                        <button type="button" class="btn btn-success float-right" id="breakdown_btn" >Save</button> 
...
{{-- market positioning--}}
             <div class="tab-pane p-20" id="messages6" role="tabpanel" style="padding:40px">
              <div class="container">
                 <div class="row justify-content-center">
                    ...
                    <div class="iframe">
                     ...
                     <div class="form-group mt-5 mb-5">
                        <label class="mb-4"><abbr title="Using the information received from market positioning chart, please write your analysis from market positioning" data-toggle="tooltip">Market Analysis</abbr> <small>(100-400 words)</small><label class="text-danger h5">*</label></label>
                 ...
                 <button type="button" id="market_next_btn" class="btn btn-success float-right ml-1">Next</button>
              </div>
             </div>
    ...
    <div class="row">
        ...
        <div class="float-right">
          @if($ent->admin_status=="Draft")
            ...
            @endif
             <a href="{{url('ent/startup/profile')}}"><button type="button"  class="btn btn-info float-right">Preview</button></a>
        </div>
...
<script src="{{asset('public/page_js/startup.js')}}"></script>
@if(session()->has('note'))
<script>
    ...
    $("#tupdate_form").on('submit', function(e){
     $(".tupload").css('display','block');  
        ...
        $.ajax({
            ...
            type: 'POST',
            url: '{{url("ent/startup/tazkira/update")}}',
    ...
    $("#uploadForm2").on('submit', function(e){
     $(".upload2").css('display','block');  
        ...
        $.ajax({
            ...
            type: 'POST',
            url: '{{url("ent/startup/busniess_logo/update")}}',
            data:new FormData(this),
            contentType: false,
            cache: false,
            processData:false,
    ...
    $("#uploadForm3").on('submit', function(e){
     $(".upload3").css('display','block');  
        ...
        $.ajax({
            ...
            type: 'POST',
            url: '{{url("ent/startup/busniess_plan/update")}}',
            data:new FormData(this),
            contentType: false,
            cache: false,
            processData:false,
    ...
    $("#uploadForm4").on('submit', function(e){
     $(".upload4").css('display','block');  
        ...
        $.ajax({
            ...
            type: 'POST',
            url: '{{url("ent/startup/pitch_deck/update")}}',
            data:new FormData(this),
            contentType: false,
            cache: false,
            processData:false,
    ...
    $("#uploadForm5").on('submit', function(e){
     $(".upload5").css('display','block');  
        ...
        $.ajax({
            ...
            type: 'POST',
            url: '{{url("ent/startup/busniess_license/update")}}',
            data:new FormData(this),
            contentType: false,
            cache: false,
            processData:false,
    ...
    $("#uploadForm6").on('submit', function(e){
     $(".upload6").css('display','block');  
        ...
        $.ajax({
            ...
            type: 'POST',
            url: '{{url("ent/startup/Business_profile/update")}}',
            data:new FormData(this),
            contentType: false,
            cache: false,
            processData:false,
    ...
    $("#uploadForm7").on('submit', function(e){
     $(".upload7").css('display','block');  
        ...
        $.ajax({
            ...
            type: 'POST',
            url: '{{url("ent/startup/store_market_position")}}',
            data:new FormData(this),
            contentType: false,
            cache: false,
            processData:false,
...
jQuery("#first").submit(function(e){
 $('#sub12').html('<i class="fa fa-spinner fa-spin"></i>&nbsp;Saving....').attr('disabled',true);  
    ...
    var url ="{{url('ent/startup/profile/update')}}";
    $.ajax({
    type:'POST',
     url:url,
...
$(document).ready(function () {
 $('#submit_define').click(function(){
  ...
  var url="{{url('ent/startup/business_minimum_viable_product')}}";
    $.ajaxSetup({
        headers: {
            'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
        }
...
$('#product_specifications').click(function(){
 ...
 var body = tinymce.get("mymce14").getContent();
  ...
  var url="{{url('ent/startup/high_level_product')}}";
  $.ajaxSetup({
        headers: {
            'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
        }
...
$('#product_need').click(function(){
 ...
 var inputdata = JSON.stringify({'inputdata':body});
 var url="{{url('ent/startup/product_need/')}}";
  $.ajaxSetup({
        headers: {
            'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
        }
...
$('#product_plan_btn').click(function(){
 ...
 var inputdata = JSON.stringify({'inputdata':body});
 var url="{{url('ent/startup/product_plan/')}}";
  $.ajaxSetup({
        headers: {
            'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
        }
...
$('#busniess_submit').click(function(){
 $(this).html('<i class="fa fa-spinner fa-spin"></i>&nbsp;Saving....').attr('disabled',true);  
  ...
  var url="{{url('ent/startup/store_busniess_model')}}";
  $.ajaxSetup({
        headers: {
            'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
        }
...
$('#elavtor_submit').click(function(){
 $(this).html('<i class="fa fa-spinner fa-spin"></i>&nbsp;Saving....').attr('disabled',true);  
  ...
  var url="{{url('ent/startup/profile/update1')}}";
  $.ajaxSetup({
        headers: {
            'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
        }
...
// ajax
$('#bsniess__trends_submit').click(function () {
 $('#bsniess__trends_submit').html('<i class="fa fa-spinner fa-spin"></i>&nbsp;Saving....').attr('disabled',true);  
    ...
    var inputdata = JSON.stringify({'inputdata':body});
    var url ="{{url('ent/startup/busness_trends_add')}}";
    $.ajax({
    type:'POST',
     url:url,
     data: {inputdata:inputdata},
...
$('#risk_button').click(function(){
    ...
    var inputdata = JSON.stringify({'inputdata':body});
    var url="{{url('ent/startup/risk_a_add')}}";
     $.ajaxSetup({
           headers: {
               'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
           }
...
$('#the_market_btn').click(function(){
    ...
    var inputdata = JSON.stringify({'inputdata':body});
    var url="{{url('ent/startup/store_the_market')}}";
    $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
            }
...
$('#def_investment_btn').click(function(){
    ...
    var inputdata = JSON.stringify({'inputdata':body});
    var url="{{url('ent/startup/store_define_invest')}}";
    $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
            }
...
$('#define_your_plan').click(function(){
    ...
    var inputdata = JSON.stringify({'inputdata':body});
    var url="{{url('ent/startup/store_define_invest_plan')}}";
    $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
            }
...
$('#breakdown_btn').click(function(){
    ...
    var inputdata = JSON.stringify({'inputdata':body});
    var url="{{url('ent/startup/store_define_invest_breakdown')}}";
    $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
            }
...
$('#calculate_btn').click(function(){
    ...
    var inputdata = JSON.stringify({'inputdata':body});
    var url="{{url('ent/startup/calculate_cost')}}";
    $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
            }
...
$('#segment_market_btn').click(function(){
    ...
    var url="{{url('ent/startup/store_market_segment')}}";
    $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
            }
...
jQuery("#question_form").submit(function(e){
  ...
  $('#question_btn').html('<i class="fa fa-spinner fa-spin"></i>&nbsp;Saving....').attr('disabled',true);  
    ...
    $.ajax({
    type:'POST',
    url:"{{ url('ent/startup/b_head_question') }}",
...
$('#beachhead_summary_btn').click(function(){
 $(this).html('<i class="fa fa-spinner fa-spin"></i>&nbsp;Saving....').attr('disabled',true);  
  ...
  var url="{{url('ent/startup/b_head_summary')}}";
  $.ajaxSetup({
        headers: {
            'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
        }
...
$('#total_market_size').click(function(){
  ...
  var inputdata = JSON.stringify({'inputdata':body});
  var url="{{url('ent/startup/b_head_total_market_size')}}";
  $.ajaxSetup({
        headers: {
            'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
        }
...
$('#life_cycle_btn').click(function(){
 ...
 var inputdata = JSON.stringify({'inputdata':body});
 var url="{{url('ent/startup/b_head_market_life_cycle')}}";
  $.ajaxSetup({
        headers: {
            'X-CSRF-TOKEN':'@php echo csrf_token() @endphp ',
        }
 ...
 jQuery("#intial_invest_form").submit(function(e){
  ...
  $('#intial_invest').html('<i class="fa fa-spinner fa-spin"></i>&nbsp;Saving....').attr('disabled',true);  
    ...
    var url ="{{url('ent/startup/financial/first')}}";
    $.ajax({
    type:'POST',
     url:url,
     data: {
...
jQuery("#operation_cost_form").submit(function(e){
 ...
 $('#operation_cost_btn').html('<i class="fa fa-spinner fa-spin"></i>&nbsp;Saving....').attr('disabled',true);  
   ...
   var url ="{{url('ent/startup/financial/second')}}";
   $.ajax({
   type:'POST',
    url:url,
...
jQuery("#revenue_form").submit(function(e){
 ...
 $('#revenue_btn').html('<i class="fa fa-spinner fa-spin"></i>&nbsp;Saving....').attr('disabled',true);  
   ...
   var url ="{{url('ent/startup/financial/forth')}}";
   $.ajax({
   type:'POST',
    url:url,
...
jQuery("#profit_form").submit(function(e){
 ...
 $('#profit_btn').html('<i class="fa fa-spinner fa-spin"></i>&nbsp;Saving....').attr('disabled',true);  
   ...
   var url ="{{url('ent/startup/financial/third')}}";
   $.ajax({
   type:'POST',
    url:url,
...
$('body').on( "click",'.data', function() {
    ...
    url ='{{url("ent/startup/busniess_modal_content")}}/'+data2;
  ...
  $(".delete").click(function () {
          ...
          url = '{{url("ent/startup/add/team/member/delete")}}/'+id;
          Swal.fire({
              title: 'Are you sure?',
    ...
    var url="{{url('ent/startup/profile/update4')}}";
