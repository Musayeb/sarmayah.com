@extends('master')
@section('title')
Idea Edit Team Member - Sarmayah.com
@endsection
               ...
               <main class="col-md-8">
                  <div class="shadow-sm rounded bg-white mb-3">
                     ...
                     <div class="box-body pl-5 pr-5 pt-2 mt-2">
                           <form class="js-validate" action="{{url('ent/idea/update/team/member')}}" method="post"
                          ...
                          @php $id=encrypt($member[0]->team_id) @endphp
                            <input type="hidden" name="id" value="{{$id}}">
                              ...
                              <div class="col-sm-6 mb-2">
                               ...
                               data-tagator-show-all-options-on-focus="true" placeholder="position"  value="{{$member[0]->position}}"  data-tagator-autocomplete="['Founder', 'Co-Founder', 'CEO', 'Chief Financial Officer', 'Partner','Advisor']">
