@extends('master')
@section('title')
Startup Edit Team Member - Sarmayah.com
@endsection
               ...
               <main class="col-md-8">
                  <div class="shadow-sm rounded bg-white mb-3">
                     ...
                     <div class="box-body pl-5 pr-5 pt-2 mt-2">
                           <form class="js-validate" action="{{url('ent/startup/update/team/member')}}" method="post"
                          ...
                          @php $id=encrypt($member[0]->team_id) @endphp
                            <input type="hidden" name="id" value="{{$id}}">
			                 ...
			                 <input  type="text" class="tagator form-control" name="position" 
                               data-tagator-show-all-options-on-focus="true" placeholder="Position" data-tagator-autocomplete="['Founder', 'Co-Founder', 'CEO', 'Chief Financial Officer', 'Partner','Advisor']" value="{{$member[0]->position}}">
                                 ...
                                 <div class="js-form-message">
                                   <label class="form-label" >
                                    Short Bio &nbsp;(Maximum words 50)<span class="text-danger">*</span></label>
                               		...
                               		<div class="form-group">
                               		<textarea id="mymce1" name="bio">{{old('bio')}} {{$member[0]->summary}}</textarea>	
