@extends('master')
@section('title')
Startup Add Team Member - Sarmayah.com
@endsection
               ...
               <main class="col-md-8">
                  <div class="shadow-sm rounded bg-white mb-3">
                     ...
                     <div class="box-body pl-5 pr-5 pt-2 mt-2">
                           <form class="js-validate" action="{{url('ent/startup/add/team/member/add')}}" method="post"
                          ...
                          {!!$errors->first('full_name', '<small class="text-danger ml-2">:message</small>')!!}
                              ...
                              <div class="col-sm-6 mb-2">
                               ...
                               data-tagator-show-all-options-on-focus="true" placeholder="Position"   data-tagator-autocomplete="['Founder', 'Co-Founder', 'CEO', 'Chief Financial Officer', 'Partner','Advisor']" value="{{old('position')}}">
