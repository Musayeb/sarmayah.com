@extends('master')
@section('title')
Idea Add Team Member - Sarmayah.com
@endsection
               ...
               <main class="col-md-8">
                  <div class="shadow-sm rounded bg-white mb-3">
                     ...
                     <div class="box-body pl-5 pr-5 pt-2 mt-2">
                           <form class="js-validate" action="{{url('ent/idea/add/team/member/add')}}" method="post"
                          ...
                          {!!$errors->first('full_name', '<small class="text-danger ml-2">:message</small>')!!}
                              ...
                              <div class="col-sm-6 mb-2">
                               ...
                               <input  type="text" class="tagator form-control" value="{{old('position')}}" name="position" 
